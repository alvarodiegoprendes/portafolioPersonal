...
@section('meta_description', 'Portafolio de Álvaro Diego Prendes - Desarrollador Full Stack especializado en Python,
    C++, Laravel, Django y desarrollo web. Proyectos freelance en Valencia, España.')
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-lg-4 mb-4 mb-lg-0 text-center">
                    <img src="{{ asset('images/foto_perfil.jpg') }}"
                        alt="Álvaro Diego Prendes - Programador Full Stack especializado en Python, Laravel y Django en Valencia, España"
                        class="img-fluid rounded-circle shadow"
                        style="max-width: 300px; width: 100%; height: 300px; object-fit: cover;">
                </div>
                <div class="col-lg-8">
            ...
            <div class="row g-4">
                    ...
                    <a href="https://github.com/alvarodiegoprendes" target="_blank" class="text-dark">
                        <div class="card card-project">
                            <div class="card-body">
                                ...
                                <p class="card-text">Aplicación desarrollada con Django Rest Framework para el manejo de un
                                    CRM</p>
                                <div class="mt-3">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-project h-100">
                        <img src="{{ asset('images/envipi.png') }}" class="card-img-top"
                            alt="Envipi - Plataforma web para gestión de envíos y logística desarrollada con Laravel por Álvaro Diego Prendes"
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text flex-grow-1">Plataforma web para gestión de envíos y logística. Solución
                                completa para empresas de transporte y paquetería.</p>
                            <div class="mt-auto">
                                <span class="badge bg-primary">Laravel</span>
                                <span class="badge bg-secondary">MySQL</span>
                                <span class="badge bg-info">Web Development</span>
                            </div>
                            <a href="https://envipi.es/" target="_blank"
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-project h-100">
                        <img src="{{ asset('images/amatoxomaitea.png') }}" class="card-img-top"
                            alt="Amatxomaitea - Sitio web de panadería desarrollado con Laravel y CSS3 por Álvaro Diego Prendes"
                            style="height: 200px; object-fit: cover;">
                        <div class="card-body d-flex flex-column">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                            ...
                            <p class="card-text flex-grow-1">Sitio web de una panadería. Diseño atractivo enfocado en la
                            ...
                            <a href="https://www.amatxomaitea.com/" target="_blank"
                                class="btn btn-outline-primary btn-sm mt-3 w-100">
                                <i class="fas fa-globe me-2"></i>Visitar Sitio
                            </a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-project h-100">
                        <img src="{{ asset('images/taller_electronica.png') }}" class="card-img-top"
                            alt="Portafolio de Electrónica - Galería de proyectos Arduino y Raspberry Pi desarrollada por Álvaro Diego Prendes"
                            style="height: 200px; object-fit: cover;">
                        <div class="card-body d-flex flex-column">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <h5 class="card-title mb-0">Portafolio Electrónica</h5>
                                <a href="https://alvarodiegoprendes.github.io/PortafolioElectronica/" target="_blank"
                                    class="text-primary">
                                    <i class="fas fa-external-link-alt fa-lg"></i>
                                </a>
                            </div>
                            <p class="card-text flex-grow-1">Portafolio de proyectos de electrónica y hardware. Galería
                                interactiva con proyectos de Arduino, Raspberry Pi y más.</p>
                            <div class="mt-auto">
                            ...
                            <div class="mb-4 flex-grow-1">
                                <div class="d-flex align-items-start mb-4">
                                    ...
                                    <div>
                                        <h5>Email</h5>
                                        <p class="mb-0"><a
                                                href="mailto:alvarodiegoprendes@gmail.com">alvarodiegoprendes@gmail.com</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-start mb-4">
